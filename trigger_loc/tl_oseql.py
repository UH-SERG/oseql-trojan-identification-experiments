...
import copy
LOG_BREAK="*"*50 + "\n"
from trigger_loc_config import triggers
from trigger_loc_utils import test_modified_code
...
def get_preds_seq_line(code_lines, args, eval_examples, pool, tokenizer, model, results_file, evaluate):
      ...
      for line_id, line in lines_dict.items():
          ...
          pred, prob_score = test_modified_code(lines_dict_modified, args, eval_examples, pool, tokenizer, model, evaluate)
