...
python3 test_outlier_methods.py \
	--folder1 /scratch1/aftab/CodeT5-original-gpu0/CodeT5/sh/saved_models/defect/1-to-0_poisoning/DCI_pr2/bart_base/bart_base_all_lr1_bs16_src512_trg3_pat2_e50/trigger_loc_expt/seq-lines/clean-examples/sample-logs \
	--folder2 /scratch1/aftab/CodeT5-original-gpu0/CodeT5/sh/saved_models/defect/1-to-0_poisoning/DCI_pr2/bart_base/bart_base_all_lr1_bs16_src512_trg3_pat2_e50/trigger_loc_expt/seq-lines/model-tricking-examples/sample-logs \
	--model bart  > bart-chk
